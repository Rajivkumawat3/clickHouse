...
# ClickHouse server - Testing Setup

This directory(clickhouse-client/README.md) contains the custom client logic used to interact with the ClickHouse server. This acts as a lightweight client for testing connection, schema retrieval, data insertion, and previewing records from ClickHouse.
